...
namespace audit.ViewModels
{
    public class MapViewModel : ViewModelBase
    {
      ...
      // string token1 = "AruGEpsg1k1f10mJnHMgXZmF71kiRXv0DlaA4j07mjN0l0n96AcwBaXBYYDDnJo9";
        ...
        public async Task InitializeAsync(MapControl map)
        {
            ...
            if (map != null)
            {
                ...
                // map.MapServiceToken = "AruGEpsg1k1f10mJnHMgXZmF71kiRXv0DlaA4j07mjN0l0n96AcwBaXBYYDDnJo9";
